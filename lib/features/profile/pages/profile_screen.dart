...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadProfileData() async {
    ...
    // if (authState is AuthAuthenticated) { // Commented out as AuthAuthenticated is not yet defined in the new cubit
      ...
      child: Form(
        ...
        child: Column(
          children: [
            ...
            TextButton.icon(
              onPressed: () {
                // context.read<AuthCubit>().logout(); // Commented out as logout is not yet defined in the new cubit
                context.go('/');
              },
